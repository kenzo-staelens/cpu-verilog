...
class Inst(Line):
    ...
    def __init__(self, line_nr, line_src):
        ...
        self._mode = 0
        self._immediate = 0
        self._dst: Operand = Operand(self, literal=False, used=False)
        self._arg_a: Operand = Operand(self, literal=False, used=False)
        self._arg_b: Operand = Operand(self, literal=False, used=False)
